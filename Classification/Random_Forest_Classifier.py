# -*- coding: utf-8 -*-
"""
Created on Fri Jun  7 10:18:58 2019

@author: Gaurav Dhelia
"""
...
class Random_Forest_Classifier():
    """
    An automated Random Forest classifier.
...
cols_list : list, optional (default="None")
    List of names of columns for which you want the Random Forest Classifier
...
Random_Forest_Train : Fits the Random Forest Classifier model on the training data
...
save_files : Calls all other functions. It calculates the univariate distribution
    ...
    def Random_Forest_Train(self):
        self.forest=RandomForestClassifier(n_estimators=100,class_weight="balanced",oob_score=True,random_state=1,n_jobs=1)
